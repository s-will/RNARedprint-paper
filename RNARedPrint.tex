...
for the design in the base pair model\todo{Didn't we plan to get rid of the bp model?}{} targeting \GCb\% and structures $\R$ with weights $\pi_0,\dots,\pi_k$. The set $\F$ thus consists of
\begin{itemize}
...
\todo[inline]{This section should include a link to the most recent version of your software or code (e.g. GitHub or
  Sourceforge) as well as a link to the archived version referenced in the manuscript. The software or code should be
  archived in an appropriate repository with a DOI or other unique identifier. For software in GitHub, we recommend
using Zenodo.}
