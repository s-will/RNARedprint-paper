...
\end{enumerate}
\end{definition}
\revised{Intuitively, the tree decomposition of an (hypergraph) $G$ is a tree structure which features all the vertices of $G$, captures all the hyperedges of $G$, and helps ensure some notion of consistency. Figure~\ref{fig:treedec} illustrates one of the optimal tree decomposition for a pair of secondary structure under the stacking energy model.}
