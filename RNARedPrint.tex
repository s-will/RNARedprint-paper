...
relate more than two positions, its dependencies cannot be similarily
...
positions) connected by \Def{hyperedges}, which are sets of
vertices. In this way, hypergraphs generalize undirected graphs, where
edges are sets of two vertices.
