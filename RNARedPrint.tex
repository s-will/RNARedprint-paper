...
%
  ...
  \revised{established} design benchmark. \revised{Our results demonstrate the efficacy and feasibility of the method in practice
...
\begin{figure}
	...
	\caption{\revised{Comparison of free-energy and Boltzmann probability for 10~000 uniform ($\pi=1$; blue dots) and Boltzmann distributed ($\pi=500$; green dots) sequences, targeting a simple structure consisting of two adjacent helices.}}
