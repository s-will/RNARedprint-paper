...
\Answer{We respectfully disagree with that assessment. This result is directly relevant to the strategy that we propose in the paper. Without showing the \#P-hardness of the design counting problem, devising an algorithm that is efficient only for fixed treewidth would be unjustified. 
