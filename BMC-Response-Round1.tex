...
\Answer{This figure illustrates the impact of the energy model on the tree-decomposition, a simple energy model leading to a much simpler tree-decomposition than the stacking model. We now describe more explicitly
}
\AnswerTODO[Sebastian]{
Add a description of tree decompositions and why they differ + New Illustration
}
\Comment{
