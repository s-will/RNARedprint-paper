...
\newcommand{\Obj}{\text{\sf \relsize{-1}MultiDefect}}
...
To that purpose, we rely on a multi-stable design objective function introduced by \citet{Hammer2017}, named \Obj in the following:
% \begin{align}
...
\begin{align}
  \label{eq:blueprintobjective}
    \Obj(S)= \quad & \frac{1}{k} \sum_{\ell=1}^{k} (E(S, R_\ell) - G(S))\notag\\
