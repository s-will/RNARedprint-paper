...
\begin{figure*}[t]
  \begin{center}
    %{\sf \bfseries A}\
    \includegraphicstop[width=0.9\textwidth]{Figs/energy_shift.pdf}\hfill
...
\caption{Comparison of the multi-stable design objective function (
  ...
  reports our improvements due to Boltzmann sampling over uniform
  sampling (as difference of mean scores).}
