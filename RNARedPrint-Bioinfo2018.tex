...
canonical and $\infty$ to non-canonical base pairs, with
$\beta\neq 0$. As previously noted~\citep{Flamm2001}, a set of target
...
The potential to form $\{\Gb, \Ub\}$ base pairs radically changes this picture. As we show, the valid designs for a set of structures cannot be counted in polynomial time, unless ${\sf\# P}={\sf FP}$. The latter equality would, in particular, imply the classic ${\sf P}={\sf NP}$, and solving $\NumDesign(G)$ is polynomial time is therefore probably difficult. 
